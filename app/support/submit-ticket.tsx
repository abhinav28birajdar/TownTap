 ...
 * 
 * Category selection, subject, description, attach files, priority
 * 
 * User Type: all
 * Requires Auth: Yes
 */
  ...
  if (loading) {
    return (
      <SafeAreaView style={styles.container}>
        <Stack.Screen options={{ title: 'Submit Support Ticket' }} />
    ...
    <SafeAreaView style={styles.container} edges={['bottom']}>
      ...
      >
        ...
        <View style={styles.content}>
          {/* TODO: Implement Submit Support Ticket UI components */}
