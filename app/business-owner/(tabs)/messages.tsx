...
const mockMessages = [
  ...
  },
  {
    ...
    lastMessage: 'Can you come tomorrow at 3 PM?',
    timestamp: '1 day ago',
    unreadCount: 1,
    avatar: null,
    online: false,
...
export default function BusinessOwnerMessagesScreen() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.searchContainer, { backgroundColor: colors.card }]}>
        ...
        <ThemedText style={styles.searchPlaceholder}>Search conversations...</ThemedText>
      </View>
