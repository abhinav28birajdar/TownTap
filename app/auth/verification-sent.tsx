 ...
 * 
 * Success message, check email instructions, resend button, change email option
 * 
 * User Type: public
 * Requires Auth: No
 */
  ...
  if (loading) {
    return (
      <SafeAreaView style={styles.container}>
        <Stack.Screen options={{ title: 'Email Verification Sent' }} />
    ...
    <SafeAreaView style={styles.container} edges={['bottom']}>
      ...
      >
        ...
        <View style={styles.content}>
          {/* TODO: Implement Email Verification Sent UI components */}
