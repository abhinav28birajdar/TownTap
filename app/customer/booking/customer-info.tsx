 ...
 * Booking Step 3 - Info
 * 
 * Name, phone, email (pre-filled), additional notes
 * 
 * User Type: customer
 * Requires Auth: Yes
 */
  ...
  if (loading) {
    return (
      <SafeAreaView style={styles.container}>
        <Stack.Screen options={{ title: 'Booking Step 3 - Info' }} />
    ...
    <SafeAreaView style={styles.container} edges={['bottom']}>
      ...
      >
        ...
        <View style={styles.header}>
          <Text style={styles.title}>Booking Step 3 - Info</Text>
        ...
        <View style={styles.content}>
          {/* TODO: Implement Booking Step 3 - Info UI components */}
