...
export default function BusinessProfile() {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      subtitle: 'Address and coverage area',
    ...
    },
    {
      ...
      subtitle: 'Payment methods and payouts',
      route: '/business/settings/payments',
    },
    {
    ...
    },
    {
      ...
      title: 'Verification',
      subtitle: 'Documents and verification',
      route: '/business/settings/verification',
    },
    {
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.profileCard}>
          ...
          <Text style={styles.businessName}>{profile?.full_name || 'Your Business'}</Text>
          <Text style={styles.businessEmail}>{profile?.email || 'email@example.com'}</Text>
        ...
        {/* Version */}
        <Text style={styles.versionText}>TownTap Business v1.0.0</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
